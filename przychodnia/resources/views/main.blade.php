                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                        ...
                        <div class="offcanvas-body pt-5">
                            <ul class="navList">
                                ...
                                <hr class="my-1" style="width: 50%;">
                                <li class="nav-item">
                                    <a class="nav-link" href="recepty.php"><i class="bi bi-file-earmark-text me-2"></i>Recepty</a>
                                </li>
                                <hr class="my-1" style="width: 50%;">
                                <li class="nav-item">
                                    <a class="nav-link" href="badania.php"><i class="bi bi-clipboard-data me-2"></i>Badania</a>
                                </li>
                                <hr class="my-1" style="width: 50%;">
                                <li class="nav-item">
                                ...
                                <hr class="my-1" style="width: 50%;">
                                <li class="nav-item">
                                    <a class="nav-link" href="placowki.php"><i class="bi bi-houses me-2"></i>Nasze placówki</a>
                                </li>
                                <hr class="my-1" style="width: 50%;">
                                <li class="nav-item">
